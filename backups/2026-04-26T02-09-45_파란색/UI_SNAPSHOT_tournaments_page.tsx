            ...
            <div className="max-w-[1400px] mx-auto space-y-12">
                ...
                <div className="flex flex-col md:flex-row justify-between items-end gap-8 border-b border-white/5 pb-10">
                    <div className="space-y-4">
                        ...
                        <h1 className="text-6xl font-black tracking-tighter leading-none text-blue-500 drop-shadow-[0_0_20px_rgba(59,130,246,0.3)]">전문 경기 기록<span className="text-white">.</span></h1>
                        <p className="text-blue-400 font-bold text-lg max-w-2xl opacity-90">대회별로 축적된 모든 경기 데이터를 정밀 분석하고 전술 패턴을 관리합니다.</p>
                    </div>
                                                ...
                                                <div className="flex flex-col gap-2">
                                                    <div className="flex items-baseline gap-8">
                                                        ...
                                                        <div className="flex items-center gap-6 text-4xl font-black tracking-tighter">
                                                            ...
                                                            <span className="flex items-center gap-3 text-white/50 text-2xl font-bold">
                                                ...
                                                >
                                                    ...
                                                    <div className="flex items-center gap-10 flex-1 relative z-10">
                                                                ...
                                                                {setsArr.map((s, idx) => (
                                                                    <div key={idx} className={cn(
                                                                        ...
                                                                        s.p > s.o 
                                                                            ...
                                                                            : "bg-white/5 text-slate-400 border-white/5 group-hover:bg-white/10 group-hover:border-white/10"
                                                                    )}>
                                                                        {s.p}:{s.o}
                                                                    </div>
                                                                ))}
                                                        ...
                                                        <div className="flex items-center gap-6">
                                                            <span className="text-2xl font-black text-blue-500 drop-shadow-sm group-hover:text-blue-400 transition-colors">
