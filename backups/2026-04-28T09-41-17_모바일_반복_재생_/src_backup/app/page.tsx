        ...
        <div className="min-h-screen bg-[#080d1a] text-white p-4 md:p-12 space-y-8 md:space-y-12 overflow-y-auto custom-scrollbar shadow-inner">
            ...
            <div className="max-w-[1500px] mx-auto flex flex-col lg:flex-row justify-between items-center lg:items-center gap-8 bg-[#0b1221] p-6 md:p-12 rounded-3xl md:rounded-[4rem] border border-white/5 relative overflow-hidden shadow-[0_0_80px_rgba(37,99,235,0.05)]">
                ...
                <div className="relative z-10 space-y-4 text-center lg:text-left w-full">
                    ...
                    <div className="flex flex-col gap-6">
                        <h1 className="text-4xl md:text-7xl font-black tracking-tight md:tracking-tighter lowercase leading-none">cockpit_intel_archive<span className="text-blue-600">.</span></h1>
                        {/* Match Type Switcher */}
            ...
            <div className="max-w-[1500px] mx-auto space-y-8 md:space-y-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
                    <div className="bg-[#0b1221] p-8 md:p-12 rounded-3xl md:rounded-[3.5rem] border border-white/5 group hover:border-blue-500/30 transition-all flex flex-col justify-between h-48 md:h-64 shadow-xl">
                        <Trophy className="w-10 h-10 md:w-14 md:h-14 text-yellow-500 drop-shadow-[0_0_10px_rgba(234,179,8,0.3)]" />
                        <div>
                            <p className="text-slate-500 font-black text-[10px] uppercase tracking-widest mb-1">Total Victories</p>
                            <h3 className="text-4xl md:text-7xl font-black text-white tracking-tighter">{currentStats.winLoss.w}<span className="text-lg md:text-2xl text-slate-700 ml-3 md:ml-5 font-bold italic">GAMES</span></h3>
                        </div>
                    </div>
                    <div className="bg-[#0b1221] p-8 md:p-12 rounded-3xl md:rounded-[3.5rem] border border-white/5 group hover:border-rose-500/30 transition-all flex flex-col justify-between h-48 md:h-64 shadow-xl">
                        <TrendingUp className="w-10 h-10 md:w-14 md:h-14 text-rose-500 drop-shadow-[0_0_10px_rgba(244,63,94,0.3)]" />
                        <div>
                            <p className="text-slate-500 font-black text-[10px] uppercase tracking-widest mb-1">Filtered Win Rate</p>
                            <h3 className="text-4xl md:text-7xl font-black text-white tracking-tighter">{currentStats.winRate}<span className="text-lg md:text-2xl text-slate-700 ml-3 md:ml-5 font-bold italic">%</span></h3>
                        </div>
                    </div>
                    <div className="bg-[#0b1221] p-8 md:p-12 rounded-3xl md:rounded-[3.5rem] border border-white/5 group hover:border-emerald-500/30 transition-all flex flex-col justify-between h-48 md:h-64 shadow-xl">
                        <BarChart3 className="w-10 h-10 md:w-14 md:h-14 text-emerald-500 drop-shadow-[0_0_10px_rgba(16,185,129,0.3)]" />
                        <div>
                            <p className="text-slate-500 font-black text-[10px] uppercase tracking-widest mb-1">Analyzed Points</p>
                            <h3 className="text-4xl md:text-7xl font-black text-white tracking-tighter">{filteredLogs.length.toLocaleString()}<span className="text-lg md:text-2xl text-slate-700 ml-3 md:ml-5 font-bold italic">LOGS</span></h3>
                        </div>
                    </div>
                </div>
