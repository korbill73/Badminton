            ...
            <div className="max-w-[1400px] mx-auto space-y-12">
                ...
                <div className="flex flex-col md:flex-row justify-between items-end gap-8 border-b border-white/5 pb-10">
                    <div className="space-y-4">
                        ...
                        <h1 className="text-6xl font-black tracking-tighter leading-none text-white">전문 경기 기록<span className="text-blue-600">.</span></h1>
                        <p className="text-slate-500 font-bold text-lg max-w-2xl">대회별로 축적된 모든 경기 데이터를 정밀 분석하고 전술 패턴을 관리합니다.</p>
                    </div>
